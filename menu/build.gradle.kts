...
kotlin {
    ...
    linuxTarget.apply {
        binaries {
            executable("lcarsde-menu") {
                entryPoint = "main"

            }
        }
        compilations.getByName("main") {
            val menu by cinterops.creating
        }
    }
    sourceSets {
        commonMain {
        ...
        linuxX64Main {
            dependencies {
                ...
                implementation(libs.kotlinx.io.core.linux)
            }
        }
        linuxX64Test {}
    }
...
tasks.named<Copy>("installDist") {
    ...
    from(file("build/bin/linuxX64/lcarsde-menuReleaseExecutable")) {
        into("/usr/bin/")
    }
}
