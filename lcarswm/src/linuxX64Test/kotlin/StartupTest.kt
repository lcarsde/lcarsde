...
class StartupTest {
    ...
    @BeforeTest
    fun setup() {
        ServiceLocator.provide<Logger> { de.atennert.lcarswm.log.LoggerMock() }
    }
    ...
    private fun checkCoreSignalRegistration(startupCalls: MutableList<de.atennert.lcarswm.system.FunctionCall>) {
    ...
    private fun checkForAtomRegistration(startupCalls: MutableList<de.atennert.lcarswm.system.FunctionCall>) {
    ...
    private fun checkUserSignalRegistration(startupCalls: MutableList<de.atennert.lcarswm.system.FunctionCall>) {
        listOf(
            Signal.USR1,
            Signal.USR2,
            Signal.TERM,
    ...
    private fun checkCreatingTheSupportWindow(
        startupCalls: MutableList<de.atennert.lcarswm.system.FunctionCall>,
        system: de.atennert.lcarswm.system.SystemFacadeMock
    ) {
    ...
    private fun checkBecomeScreenOwner(startupCalls: MutableList<de.atennert.lcarswm.system.FunctionCall>) {
    ...
    private class StartupFacadeMock : de.atennert.lcarswm.system.SystemFacadeMock() {
