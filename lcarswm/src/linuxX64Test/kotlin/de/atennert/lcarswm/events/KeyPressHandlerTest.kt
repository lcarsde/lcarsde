...
class KeyPressHandlerTest : SystemCallMocker() {
    ...
    fun `move active window to the next monitor`() {
        ...
        assertEquals(
            ...
            moveWindowCall.name,
            "The focused window should be moved to the next monitor"
        )
        assertEquals(
            windowFocusHandler.getFocusedWindow(),
            moveWindowCall.parameters[0],
            "The _focused window_ should be moved to the next monitor"
        )
    }
    ...
    fun `move active window to the previous monitor`() {
        ...
        assertEquals(
            ...
            moveWindowCall.name,
            "The focused window should be moved to the previous monitor"
        )
        assertEquals(
            windowFocusHandler.getFocusedWindow(),
            moveWindowCall.parameters[0],
            "The _focused window_ should be moved to the previous monitor"
        )
    }
    ...
    fun `don't react on move to next monitor without a focusable window`() {
        ...
        assertTrue(
            windowCoordinator.functionCalls.isEmpty(),
            "There should be no call to the window coordinator without focused window"
        )
    }
    ...
    fun `toggle focused Window forwards`() {
        ...
        assertEquals(
            window3,
            windowFocusHandler.getFocusedWindow(),
            "The focused window needs to be updated 1"
        )
        ...
        assertEquals(
            window2,
            windowFocusHandler.getFocusedWindow(),
            "The focused window needs to be updated 2"
        )
        ...
        assertEquals(
            window1,
            windowFocusHandler.getFocusedWindow(),
            "The focused window needs to be updated 3"
        )
    }
    ...
    fun `don't toggle without focusable windows`() {
        ...
        assertEquals(
            0,
            windowCoordinator.functionCalls.size,
            "There is no window to restack"
        )
    }
    ...
    fun `toggle screen mode on M`() {
        ...
        assertEquals(
            "toggleScreenMode",
            monitorModeToggleCall.name,
            "The screen mode should be toggled."
        )
    }
