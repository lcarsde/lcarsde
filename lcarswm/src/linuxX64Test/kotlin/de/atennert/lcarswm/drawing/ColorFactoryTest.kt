...
class ColorFactoryTest {
    ...
    fun `create XFT color by color`() {
        ...
        assertEquals(color.redOp, xftColor.color.red.toInt())
        assertEquals(color.greenOp, xftColor.color.green.toInt())
        assertEquals(color.blueOp, xftColor.color.blue.toInt())
