...
open class SystemFacadeMock : SystemApi {
    ...
    override fun rGetScreenResources(window: Window): CPointer<XRRScreenResources>? {
        assertEquals(
            rootWindowId,
            window,
            "The window manager should only request screen resources for the root window"
        )
    ...
    override fun rGetOutputPrimary(window: Window): RROutput {
        assertEquals(
            rootWindowId,
            window,
            "The window manager should only request the primary output for the root window"
        )
