...
class WindowFocusHandlerTest {
    @BeforeTest
    fun setup() {
        ServiceLocator.provide<Logger> { _root_ide_package_.de.atennert.lcarswm.log.LoggerMock() }
    }
    ...
    fun `check that initially there is no focused window`() {
        val systemApi = _root_ide_package_.de.atennert.lcarswm.system.SystemFacadeMock()
