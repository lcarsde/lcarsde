...
fun checkMoveWindow(
    ...
    assertEquals(
        "moveResizeWindow",
        moveResizeTitleBarCall.name,
        "The title bar needs to be moved/resized"
    )
    ...
    assertEquals(
        "moveResizeWindow",
        moveResizeFrameCall.name,
        "The frame needs to be moved/resized"
    )
    ...
    assertEquals(
        "sendEvent",
        sendEventCall.name,
        "The window needs to get a structure notify event"
    )
